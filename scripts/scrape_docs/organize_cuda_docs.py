#!/usr/bin/env python3
"""
Fetch CUDA docs from crawl API and organize into a directory tree.
"""
...
CRAWL_ID = os.environ.get("CUDA_CRAWL_ID", "019b2af4-4d39-75ab-9b62-41c351b7a4d2")
BASE_URL = f"http://127.0.0.1:3002/v2/crawl/{CRAWL_ID}"
OUTPUT_DIR = Path("/home/nymph/Code/ai/nvfp4-hackathon/docs/cuda")

# Strip this prefix from URLs to get relative paths
URL_PREFIX = "/cuda/archive/13.0.0/"
...
def url_to_filepath(url: str) -> Path:
    ...
    elif path.startswith("/cuda/archive/13.0.0"):
        path = path[len("/cuda/archive/13.0.0"):]
...
def create_index(docs_info: list):
    ...
    # Create main index
    index_content = "# CUDA Toolkit Documentation 13.0\n\n"
    index_content += "This directory contains the CUDA Toolkit 13.0 documentation.\n\n"
...
def main():
    print(f"Fetching CUDA docs from crawl {CRAWL_ID}...")

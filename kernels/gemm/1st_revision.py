...
# M and N must be 128 for MmaMXF4NVF4Op instruction with block-scaled GEMM
...
# Increase to 2 for double buffering - hides memory latency by overlapping
# loads of next tile with compute of current tile
num_acc_stage = 1
num_ab_stage = 2
...
def kernel(
    ...
    # Software pipelining with num_ab_stage=2:
    ...
    if warp_idx == 0:
        ...
        # With double buffering, the next tile's data is already being loaded while we compute
        #
